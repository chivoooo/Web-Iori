...
<body>
  <div class="container-scroller">
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?= base_url('assets/polluxui/template/') ?>images/faces/profil.jpg" alt="profile"/>
    ...
    <nav class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0">
      <div class="navbar-links-wrapper d-flex align-items-stretch">
        <div class="nav-link">
          <a href="<?= base_url(); ?>"><i class="typcn typcn-arrow-forward-outline"></i></a>
        </div>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="<?= base_url('admin/Kategori') ?>" aria-expanded="false" aria-controls="form-elements">
            <i class="typcn typcn-zoom-in-outline menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="<?= base_url('admin/Konfigurasi') ?>" aria-expanded="false" aria-controls="charts">
          ...
          <?php } ?>
          <li class="nav-item">
            <a class="nav-link"  href="<?= base_url('admin/Konten') ?>" aria-expanded="false" aria-controls="tables">
          ...
          <?php if($this->session->userdata('level')=='Admin'){ ?>
          <li class="nav-item">
            <a class="nav-link"  href="<?= base_url('admin/User') ?>" aria-expanded="false" aria-controls="icons">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Made by <a href="https://www.bootstrapdash.com/" class="text-muted" target="_blank">Chivo Poundra N.S</a></span>
  ...
  <script src="<?= base_url('assets/polluxui/template/') ?>vendors/chart.js/Chart.min.js"></script>
  ...
  <script src="<?= base_url('assets/polluxui/template/') ?>js/dashboard.js"></script>
