...
<body>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			...
			<div class="hero-item set-bg" data-setbg="<?= base_url('assets/upload/carousel/' . $car['foto']); ?>">
				<div class="container">
					<div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 blog-posts">
                    <h2 class="text-white mb-4">All Content in <?= $nama_kategori ?></h2>
					<?php foreach($konten as $k){ ?>
					<div class="blog-post featured-post">
						<img src="<?= base_url('assets/upload/konten/'.$k['foto']); ?>" alt="">
						...
						<a href="<?= base_url('home/artikel/').$k['slug'] ?>" class="site-btn">Lihat Selengkapnya</a>
					</div>
					<?php } ?>
					<div class="row">
						<div class="col-md-12">
